...
const CocktailCarousel: React.FC = () => {
  ...
  const nextSlide = () => {
    handleTransition((currentIndex + 1) % cocktails.length);
  };

  const prevSlide = () => {
    handleTransition((currentIndex - 1 + cocktails.length) % cocktails.length);
  };
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
          <div className="text-center">
            ...
            <p className="text-base mb-8 opacity-90 max-w-xl mx-auto font-light">
              {cocktails[currentIndex].description}
            </p>
