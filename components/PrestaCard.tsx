  ...
  return (
    <div className="h-full w-full flex justify-center container   ">
      <div
        ...
        className="border border-[#C7B79C] h-[300px] md:h-[400px] w-[80%] md:w-[500px] lg:w-[600px] flex items-center justify-center mt-6"
      >
        <div className="border border-[#C7B79C] h-[90%] w-[90%] ">
